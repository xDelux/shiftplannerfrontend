...
export const Header = (props) => {
    ...
    return (
        ...
        <div className="flex items-center h-20 bg-lightPrimary dark:bg-primary ">
            ...
            <div className="flex flex-row items-center bg-gray-100 dark:bg-secondary rounded-full py-1 text-black dark:text-white mx-2 mb-2 justify-self-end">
                <img
            ...
            </div>
            {
                expanded
                    ? (
                        <div  className="absolute grid grid-cols-1 gap-4 top-20 mb-2 right-3 bg-primary rounded-sm border-b-2 text-white transition duration-500 ease-in-out">
                            ...
                            <div className="p-3 hover:bg-secondary"><DarkModeIcon/>Dark mode<Switch onClick={() => applyTheme()}/></div>
                        </div> )
                    : null
            }
        </div>
